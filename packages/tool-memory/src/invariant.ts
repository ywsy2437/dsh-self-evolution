...
/**
 * No runtime invariant: the tool is a read-only projection over `memory`, whose
 * consistency the memory package owns; it owns no event stream or mutable
 * medium of its own to cross-check.
 */
